 ...
 <div class="main-sidebar sidebar-style-2">
     <aside id="sidebar-wrapper">
         ...
         <ul class="sidebar-menu">
             ...
             <li class="dropdown">
                 <a href="#" class="nav-link has-dropdown"><i class="fa-solid fa-boxes-stacked"></i><span>Genres</span></a>
                 <ul class="dropdown-menu">
                     <li><a class="nav-link" href="create-genres.php">Create Genres</a></li>
