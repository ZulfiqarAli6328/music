						...
						<div class="ms_blog_section blog_active marger_bottom30">
							...
							<div class="ms_main_overlay">
								...
								<div class="ovrly_text_div">
									<span class="ovrly_text1"><a href="blog_single.php">Fenne Lily - Three Oh Nine</a></span>
									<div class="bottom">
										<span class="ovrly_text1">May 12,2018</span>
										<span class="ovrly_text2"><a href="blog_single.php"><i class="fa fa-long-arrow-right"></i></a></span>
									</div>
								</div>
							</div>
