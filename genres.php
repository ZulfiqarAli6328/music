                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="admin/assets/genresphoto/<?= $row["cover_photo"] ?>" style="height:280px;" alt="">
                                        <div class="ms_main_overlay">
                                            ...
                                            <div class="ms_play_icon">
                                                <a href="album_single copy.php?id=<?= $row['id'] ?>">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="album_single copy.php?id=<?= $row['id'] ?>"><?= $row['genre'] ?></a></h3>
