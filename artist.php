    ...
    <div class="ms_main_wrapper">
            ...
            <div class="ms_sidemenu_inner">
                ...
                <div class="ms_nav_wrapper">
                    <ul>
                        ...
                        <li><a href="top_track.php" title="Top Track">
						<span class="nav_icon">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="artist_single.php">Ava Cornish</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="artist_single.php">Frank Adle</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="artist_single.php">Diane Hill</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="artist_single.php">Fred Dofer</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="artist_single.php">Bela Scott</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    ...
                                    <div class="ms_rcnt_box_text">
                                        <h3><a href="artist_single.php">Chandler Clark</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Claire Hudson</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Carl Brown</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Virginia Harris</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Max Glover</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Jennifer Kelly</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Harry Jackson</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Kevin Buckland</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Anna Ellison</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Kylie Greene</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Sarah Wilson</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                        ...
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Steven Walker</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Olivia Paige</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Nicole Miller</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Edward Clark</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Adam Glover</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Leah Knox</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box marger_bottom30">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Charles Davidson</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Vanessa Hunter</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="ms_rcnt_box">
                                ...
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="artist_single.php">Sophie Hudson</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="ms_footer_wrapper">
            <div class="ms_footer_logo">
                <a href="index.php"><img src="images/open_logo.png" alt=""></a>
            </div>
